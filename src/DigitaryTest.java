...
public class DigitaryTest {
    ...
    int errorCount, index, rows_count, rows_count_after_deletion;
    ...
    //@Test
     public void test_09_incomplete_details_error_message () {
    ...
    //@Test
    public void test_08_signout(){
        //Testcasse :- Test to signout of the applicaiton
        //Testdata :- Valid email and password
        signIn(validEmail, validPassword);
        this.driver.findElement(By.xpath("//*[@id=\"navbar\"]/div[1]/a[3]")).click();
        Assert.assertEquals(signinUrl, this.driver.getCurrentUrl());

    }

    //@Test
    public void test_09_edit_an_address(){
        //Testcasse :- Test to destroy the row which has any entry mentioned
        //Testdata :- Value of the row to be deleted.
        signIn(validEmail, validPassword);
        edit_address("test");
    ...
    //@Test
    public void test_09_show_an_address(){
    ...
    public void destroy(String elementTobeDeleted)
    {
        ...
        if (index==0) {
            ...
            Assert.assertEquals(1,rows_count-rows_count_after_deletion);
